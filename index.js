...
const intervalId2 = setInterval(nextSlide2, 4000); // Change 3000 to adjust the interval time
const container2 = document.getElementById('pagek');
...
//     intervalId = setInterval(nextSlide2, 3000); // Change 3000 to adjust the interval time
// });
